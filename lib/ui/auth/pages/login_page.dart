            ...
            child: Column(
              ...
              children: [
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.shopping_cart, color: Color(0xFF4F8962), size: 50,),
                    Text('Texno Bazar', style: TextStyle(color: Color(0xFF4F8962), fontWeight: FontWeight.w800, fontSize: 30),)
                  ],
                ),
                SizedBox(height: 20),
                GlobalTextField(
                ...
                Row(
                  ...
                  children: [
                    TextButton(
                        ...
                        child: const Text("Sign Up", style: TextStyle(color: Color(0xFF4F8962), fontSize: 18, fontWeight: FontWeight.w800),)),
                  ],
                ),
                TextButton(
                    onPressed: () {
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const Text("Sign Up with Google", style: TextStyle(color: Color(0xFF4F8962), fontSize: 18, fontWeight: FontWeight.w800)),
                      ],
                    )),
              ],
            ),
